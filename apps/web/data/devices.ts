...
export const fallbackDevices: Device[] = [
  {
    ...
    exit: "до 42 000 ₽",
    exitText: "Предварительная стоимость при обновлении — до 42 000 ₽ после повторной диагностики",
    availability: "Устройство в наличии в Store. Карточка проверена перед публикацией.",
    shortDescription:
      "256 GB · Graphite · грейд A− · батарея 89% · гарантия 90 дней · предварительная стоимость при обновлении до 42 000 ₽ после повторной диагностики.",
    ...
    passport: {
      ...
      exitPrice: {
        ...
        note: "Предварительная стоимость при обновлении не является обещанием выкупа: итог зависит от состояния, комплектации, спроса и результатов повторной диагностики.",
      },
    },
    trade: {
      options: [
  ...
  },
  {
    ...
    warrantyText: "Гарантия 90 дней",
    exit: "до 45 000 ₽",
    exitText: "Предварительная стоимость при обновлении — до 45 000 ₽ после повторной диагностики",
    availability: "Устройство в наличии в Store. Карточка проверена перед публикацией.",
    shortDescription:
      "128 GB · Starlight · грейд A · батарея 94% · гарантия 90 дней · предварительная стоимость при обновлении до 45 000 ₽ после повторной диагностики.",
  ...
  },
  {
    ...
    warrantyText: "Гарантия 90 дней",
    exit: "до 49 000 ₽",
    exitText: "Предварительная стоимость при обновлении — до 49 000 ₽ после повторной диагностики",
    availability: "Устройство в наличии в Store. Карточка проверена перед публикацией.",
    shortDescription:
      "8 / 256 GB · Silver · грейд B+ · 214 циклов · гарантия 90 дней · предварительная стоимость при обновлении до 49 000 ₽ после повторной диагностики.",
    ...
    passport: {
      ...
      exitPrice: {
        ...
        condition: "состояние не ниже B",
        note: "Предварительная стоимость при обновлении не является обещанием выкупа: итог зависит от состояния, числа циклов, спроса и результатов повторной диагностики.",
      },
    },
    trade: {
      options: [
  ...
  },
  {
    ...
    warrantyText: "Гарантия 90 дней",
    exit: "до 31 000 ₽",
    exitText: "Предварительная стоимость при обновлении — до 31 000 ₽ после повторной диагностики",
    availability: "Устройство в наличии в Store. Карточка проверена перед публикацией.",
    shortDescription:
      "64 GB · Wi‑Fi · грейд A · гарантия 90 дней · предварительная стоимость при обновлении до 31 000 ₽ после повторной диагностики.",
