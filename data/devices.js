  ...
  "devices": [
    {
      ...
      "shortDescription": "256 GB · Graphite · грейд A− · батарея 89% · гарантия 90 дней · ориентир выхода до 42 000 ₽.",
      ...
      "passport": {
        ...
        "story": {
          ...
          "body": "Эта вещь пришла от постоянного клиента ISVOI: использовалась как основной рабочий телефон для встреч, поездок и деловой связи. Перед передачей данные удалены, устройство прошло диагностику, а небольшие следы на ребре уже учтены в грейде и цене.",
          "facts": [
    ...
    },
    {
      ...
      "availability": "Устройство в наличии в Store. Карточка проверена перед публикацией.",
      "shortDescription": "128 GB · Starlight · грейд A · батарея 94% · гарантия 90 дней · ориентир выхода до 45 000 ₽.",
      ...
      "passport": {
        ...
        "condition": {
          ...
          "defectPhotoAlt": "Крупный план кромки корпуса iPhone 14 с минимальными следами использования"
        },
        "story": {
          "title": "Телефон после аккуратного апгрейда",
          "body": "iPhone перешёл в ISVOI после планового обновления на свежую модель. Им пользовались бережно: без ремонта, без следов влаги и без спорных сервисных вмешательств. Поэтому история вещи короткая и понятная: покупка, аккуратное использование, проверка, новая карточка в Store.",
          "facts": [
    ...
    },
    {
      ...
      "availability": "Устройство в наличии в Store. Карточка проверена перед публикацией.",
      "shortDescription": "8 / 256 GB · Silver · грейд B+ · 214 циклов · гарантия 90 дней · ориентир выхода до 49 000 ₽.",
      ...
      "passport": {
        ...
        "story": {
          ...
          "facts": [
            "Рабочая история без ремонта",
            "214 циклов батареи",
            "Следы корпуса учтены в цене"
          ]
        },
        "warranty": {
          "duration": "90 дней",
          "covered": "Заявленные функции устройства: экран, клавиатура, трекпад, порты, динамики, микрофоны, Wi‑Fi и базовая работоспособность.",
          "notCovered": "Механические повреждения после покупки, следы влаги после передачи, самостоятельный ремонт и нарушение условий эксплуатации."
        },
        "exitPrice": {
          "headline": "до 49 000 ₽",
    ...
    },
    {
      ...
      "passport": {
        ...
        "warranty": {
          "duration": "90 дней",
          "covered": "Заявленные функции устройства: экран, Touch ID, камеры, разъёмы, динамики, микрофоны, Wi‑Fi и базовая работоспособность.",
          "notCovered": "Механические повреждения после покупки, следы влаги после передачи, самостоятельный ремонт и нарушение условий эксплуатации."
        },
        "exitPrice": {
          "headline": "до 31 000 ₽",
