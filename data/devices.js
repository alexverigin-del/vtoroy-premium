    ...
    },
    {
      ...
      "passport": {
        ...
        "exitPrice": {
          ...
          "condition": "состояние не ниже B",
          "note": "Цена выхода не является безусловным обещанием выкупа: финальная сумма зависит от состояния, числа циклов, спроса и результатов повторной диагностики."
        }
      },
      "trade": {
        "options": [
