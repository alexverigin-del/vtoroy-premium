...
| `brand`             | string                        | Public brand; `Apple` for the current catalog.                                             |
| `year`              | integer                       | Model year/generation when confirmed.                                                      |
| `model_identifier`  | string                        | Exact model identifier from diagnostics.                                                   |
| `region`            | string                        | Device region.                                                                             |
| `sim`               | string                        | SIM/eSIM configuration.                                                                    |
| `battery_cycles`    | integer                       | Cycle count at diagnostic date.                                                            |
| `diagnostic_date`   | date                          | Date of the latest complete diagnostics.                                                   |
| `activation_lock`   | string                        | Activation Lock check result.                                                              |
| `mdm`               | string                        | MDM check result.                                                                          |
| `completeness`      | text                          | Included accessories and packaging.                                                        |
| `diagnostic_by`     | string                        | Responsible diagnostician or role.                                                         |
| `battery_text`      | string                        |                                                                                            |
