...
- группа `Страница города и SEO`: заголовок и описание первого экрана,
  главная фотография магазина, SEO title и meta description. Для Белгорода
  эти поля управляют канонической страницей `/belgorod`; фотография выводится
  отдельным блоком перед локальным каталогом.
