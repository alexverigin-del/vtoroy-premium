...
- Blog Phase 1–3 is implemented locally but is not committed, pushed, deployed
  or applied to production Directus yet. Production navigation and production
...
- Local verification completed on 2026-07-19: SQL generators pass Node syntax
  ...
  state is complete, and the Blog link is intentionally absent from navigation
  until production schema, preview and first draft QA are proven.
