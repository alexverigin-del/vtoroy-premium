...
- The user explicitly authorized the release. Commits through `e49484b` are pushed to GitHub `master` and production is running exact commit `e49484b4dccaef304dac87dacad3e0624173758c`. Backup `/opt/isvoi/backups/telegram-notifications-20260905T164908332Z` was created and verified by the release gate.
