...
Поле `Основной текст` поддерживает ограниченное безопасное форматирование:
абзацы, перенос строки, жирное и курсивное начертание, маркированные и
нумерованные списки, а также ссылки. Скрипты, стили, встроенные медиа и другие
HTML-элементы сайт удаляет при чтении из Directus.
