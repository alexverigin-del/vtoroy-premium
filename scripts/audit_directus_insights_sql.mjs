...
WITH expected_dashboard(id, name) AS (
  ...
  VALUES
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0101'::uuid,'Новые заявки'::varchar,'metric'::varchar,0,0,18,6,'{"collection":"leads","field":"id","function":"count","filter":{"status":{"_eq":"new"}},"numberStyle":"decimal","notation":"standard","minimumFractionDigits":0,"maximumFractionDigits":0,"textAlign":"center","fontWeight":700,"fontStyle":"normal","fontSize":"auto","font":"sans-serif","conditionalFormatting":[{"operator":">","value":"0","color":"#d97706"}]}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0102'::uuid,'Заявки требуют внимания'::varchar,'metric'::varchar,18,0,18,6,'{"collection":"leads","field":"id","function":"count","filter":{"_and":[{"status":{"_in":["new","in_progress","waiting"]}},{"_or":[{"assigned_to":{"id":{"_null":true}}},{"next_action_at":{"_lt":"$NOW"}}]}]},"numberStyle":"decimal","notation":"standard","minimumFractionDigits":0,"maximumFractionDigits":0,"textAlign":"center","fontWeight":700,"fontStyle":"normal","fontSize":"auto","font":"sans-serif","conditionalFormatting":[{"operator":">","value":"0","color":"#dc2626"}]}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0103'::uuid,'Товары доступны'::varchar,'metric'::varchar,0,6,18,6,'{"collection":"products","field":"id","function":"count","filter":{"_and":[{"status":{"_eq":"published"}},{"stock_status":{"_eq":"available"}}]},"numberStyle":"decimal","notation":"standard","minimumFractionDigits":0,"maximumFractionDigits":0,"textAlign":"center","fontWeight":700,"fontStyle":"normal","fontSize":"auto","font":"sans-serif","conditionalFormatting":[{"operator":">","value":"0","color":"#059669"}]}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0104'::uuid,'Открытые блокеры'::varchar,'metric'::varchar,18,6,18,6,'{"collection":"inventory_import_issues","field":"id","function":"count","filter":{"_and":[{"severity":{"_eq":"blocker"}},{"resolved":{"_eq":false}}]},"numberStyle":"decimal","notation":"standard","minimumFractionDigits":0,"maximumFractionDigits":0,"textAlign":"center","fontWeight":700,"fontStyle":"normal","fontSize":"auto","font":"sans-serif","conditionalFormatting":[{"operator":">","value":"0","color":"#dc2626"}]}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0105'::uuid,'Заявки за 30 дней'::varchar,'time-series'::varchar,0,12,36,14,'{"collection":"leads","color":"#2563eb","function":"count","precision":"day","dateField":"created_at","range":"1 month","valueField":"id","decimals":0,"curveType":"straight","fillType":"solid","missingData":"0","filter":{},"showXAxis":true,"showYAxis":true}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0106'::uuid,'Готовность каталога'::varchar,'metric-list'::varchar,0,26,18,10,'{"collection":"products","limit":8,"groupByField":"content_status","aggregateField":"id","aggregateFunction":"count","sortDirection":"desc","filter":{},"numberStyle":"decimal","notation":"standard","minimumFractionDigits":0,"maximumFractionDigits":0,"conditionalFormatting":[{"operator":">","value":"0","color":"#2563eb"}]}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0107'::uuid,'Активные заявки'::varchar,'list'::varchar,0,36,36,12,'{"collection":"leads","limit":5,"sortField":"created_at","sortDirection":"desc","displayTemplate":"{{status}} · {{contact}} · {{kind}}","linkToItem":true,"filter":{"status":{"_in":["new","in_progress","waiting"]}}}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0108'::uuid,'Последние блокеры'::varchar,'list'::varchar,0,48,36,12,'{"collection":"inventory_import_issues","limit":5,"sortField":"created_at","sortDirection":"desc","displayTemplate":"{{code}} · {{message}}","linkToItem":true,"filter":{"_and":[{"severity":{"_eq":"blocker"}},{"resolved":{"_eq":false}}]}}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0109'::uuid,'Заявки по типам'::varchar,'metric-list'::varchar,18,26,18,10,'{"collection":"leads","limit":8,"groupByField":"kind","aggregateField":"id","aggregateFunction":"count","sortDirection":"desc","filter":{"created_at":{"_gte":"$NOW(-90 days)"}},"numberStyle":"decimal","notation":"standard","minimumFractionDigits":0,"maximumFractionDigits":0,"conditionalFormatting":[{"operator":">","value":"0","color":"#6366f1"}]}'::json),
    ('f7a3e5bc-1c5b-4d72-8b91-0ea45c6f0110'::uuid,'Последние импорты'::varchar,'list'::varchar,0,60,36,12,'{"collection":"inventory_import_batches","limit":5,"sortField":"snapshot_at","sortDirection":"desc","displayTemplate":"{{snapshot_at}} · {{batch_name}} · {{status}} · {{blocker_count}} блокеров","linkToItem":true,"filter":{}}'::json)
