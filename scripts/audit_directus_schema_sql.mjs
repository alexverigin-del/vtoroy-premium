...
expected_fields(table_name, field_name) AS (
  VALUES
    ...
    ('products', 'brand'),
    ('products', 'category'),
    ('products', 'device_model'),
    ('products', 'price'),
    ('products', 'stock_quantity'),
    ('products', 'listing_file'),
    ('product_brands', 'slug'),
    ('product_categories', 'slug'),
    ('product_categories', 'catalog_section'),
    ('device_models', 'brand'),
    ('device_models', 'slug'),
    ...
    ('product_compatible_models', 'device_models_id'),
    ('site_pages', 'slug'),
    ('site_pages', 'status'),
    ('site_pages', 'sections'),
    ('site_pages', 'og_image'),
    ...
    ('page_sections', 'closing_headline'),
    ('page_sections', 'closing_body'),
    ('page_sections', 'closing_brand'),
    ('page_sections', 'closing_tagline'),
    ('page_sections', 'closing_primary_cta_label'),
    ('page_sections', 'closing_primary_cta_url'),
    ('page_sections', 'closing_secondary_cta_label'),
    ('page_sections', 'closing_secondary_cta_url'),
    ...
    ('blog_posts_devices', 'products_id'),
    ...
    ('inventory_receipt_lines', 'received_on'),
    ('inventory_receipt_lines', 'movement_status'),
    ('inventory_receipt_lines', 'central_office_quantity'),
...
expected_relations(many_collection, many_field, one_collection) AS (
  VALUES
    ...
    ('products', 'device_model', 'device_models'),
    ('products', 'listing_file', 'directus_files'),
    ...
    ('device_passports', 'product', 'products'),
    ('trade_options', 'product', 'products'),
    ...
    ('blog_posts_devices', 'products_id', 'products'),
