...
try {
  ...
  for (const file of [
    ...
    ...(production ? ['scripts/telegram_production_contract.mjs','scripts/setup_directus_telegram_production_sql.mjs','scripts/telegram_conversations_contract.mjs','scripts/setup_directus_telegram_conversations_sql.mjs','scripts/telegram_notifications_contract.mjs','scripts/setup_directus_telegram_notifications_sql.mjs'] : []),
    ...
    'infra/directus-beget/extensions-bundled/directus-extension-isvoi-telegram/src/notifications.js',
  ]) {
