...
const auditDefinitions = {
  ...
  studio: {
    ...
    zero: [
      ...
      "studio.admin.access_missing",
      "studio.admin.bookmarks_missing",
      "studio.admin.bookmarks_duplicates",
      ...
      "studio.inventory.operator_groups_readonly",
  ...
  "catalog-v3": {
    ...
    zero: [
      ...
      "catalog_v3.permissions.editor_child_system_write",
      "catalog_v3.permissions.editor_compatibility_missing",
      ...
      "catalog_v3.publication.used_passport_content_missing",
      "catalog_v3.publication.new_items_missing_diagnostic_date",
      "catalog_v3.publication.used_items_missing_diagnostic_by",
      "catalog_v3.publication.inventory_unconfirmed",
      "catalog_v3.readiness.ready_draft_blockers",
      "catalog_v3.transition.mixed_source_visibility",
      "catalog_v3.transition.published_legacy_devices",
      "catalog_v3.transition.published_offers_for_hidden_products",
  ...
  multicity: {
    ...
    zero: [
      ...
      "multicity.schema.location_footer_fields_missing",
      "multicity.schema.site_footer_copy_fields_missing",
      "multicity.schema.city_page_copy_fields_missing",
      "multicity.schema.relations_missing",
      "multicity.studio.collection_layout",
      "multicity.content.belgorod_missing",
      "multicity.content.legacy_store_published",
      "multicity.content.published_footer_incomplete",
      "multicity.content.published_hero_missing",
      "multicity.content.published_city_page_copy_incomplete",
      "multicity.content.invalid_map_url",
      "multicity.content.site_footer_copy_incomplete",
      ...
      "multicity.permissions.location_footer_fields_missing",
      "multicity.permissions.site_footer_copy_fields_missing",
      "multicity.permissions.city_page_copy_fields_missing",
      "multicity.permissions.editor_actions_missing",
      "multicity.studio.city_page_groups_missing",
  ...
  "trade-mvp": {
    ...
    zero: [
      ...
      "trade_mvp.supported_models_missing",
      "trade_mvp.active_configs_invalid",
      "trade_mvp.active_rules_invalid",
      "trade_mvp.active_settings_invalid",
  ...
  inventory: {
    ...
    zero: [
      ...
      "inventory.studio.item_metadata_missing",
      "inventory.studio.operator_groups_readonly",
      "inventory.studio.resolved_preset_missing",
      "inventory.studio.resolution_note_condition_missing",
      ...
      "inventory.security.issue_item_read_missing",
      ...
      "inventory.guards.issue_resolution_missing",
      "inventory.data.invalid_item_values",
      "inventory.data.resolved_without_note",
      "inventory.data.eligible_without_review",
      "inventory.data.active_inventory_issues_unlinked",
