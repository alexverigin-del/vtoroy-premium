...
const items = [
  {
    ...
    answer:
      "Да. Устройства продаются с письменной гарантией. Срок и условия указаны в карточке и Passport конкретной вещи.",
  },
  {
    key: "general-payment",
    category: "general",
    ...
    answer:
      "Доступные способы оплаты лучше уточнить перед визитом. Мы заранее подтверждаем итоговую цену, комплектацию и условия.",
  },
  {
    key: "general-city",
    category: "general",
    ...
    answer:
      "Основной сценарий — спокойная очная проверка в Store. Так можно увидеть состояние, Passport и комплектацию до решения.",
  },
  {
    key: "catalog-reserve",
    category: "catalog",
    ...
    answer:
      "Да, если устройство доступно. В карточке статус помогает понять, свободна вещь, забронирована или уже продана.",
  },
  {
    key: "catalog-photos",
    category: "catalog",
    ...
    answer:
      "Для товарных карточек используются фотографии конкретного устройства. Если фото ещё на проверке, карточка остаётся в подготовке.",
  },
  {
    key: "catalog-status",
    category: "catalog",
    ...
    answer:
      "Обычно это значит, что вещь продана, забронирована или временно скрыта до уточнения состояния, цены или фото.",
  },
  {
    key: "store-visit",
    category: "store",
    ...
    answer:
      "Лучше написать заранее: так мы подготовим нужные устройства, проверим актуальность статуса и спокойно выделим время.",
  },
  {
    key: "store-check",
    category: "store",
    ...
    answer:
      "Да. Смысл Store в открытой проверке: состояние, функции и комплектация обсуждаются до покупки, а не после.",
  },
  {
    key: "store-choice",
    category: "store",
    ...
    answer:
      "Да. Мы отталкиваемся от сценария владения, бюджета, состояния и будущей цены выхода, а не только от модели.",
  },
  {
    ...
    answer:
      "Сначала проверяем модель, память, состояние, батарею, ремонт, комплект и спрос. После этого предлагаем понятный сценарий выхода.",
  },
  {
    key: "trade-options",
    category: "trade",
    ...
    answer:
      "Да. Возможны быстрый выкуп, комиссия или зачёт устройства при обновлении. Подходящий вариант зависит от сроков и цели.",
  },
  {
    key: "trade-documents",
    category: "trade",
    ...
    answer:
      "Принесите само устройство, зарядку или комплект при наличии, документы о покупке, если они сохранились, и снимите блокировки.",
  },
  {
    key: "trade-time",
    category: "trade",
    ...
    answer:
      "Базовая проверка обычно проходит быстро, но точное время зависит от устройства, состояния и количества вопросов по истории.",
  },
  {
    key: "passport-what",
    category: "passport",
    page: "passport",
    sort: 10,
    question: "Что такое I СВОИ Passport?",
    answer:
      "Это понятная история устройства: состояние, диагностика, известные ремонты, отмеченные дефекты и гарантия простым языком.",
  },
  {
    ...
    answer:
      "Письменная гарантия покрывает функциональные неисправности, которые не были зафиксированы в Passport и не связаны с новым повреждением.",
  },
  {
    ...
    answer:
      "Итог зависит от состояния при повторной диагностике, спроса и комплектации. Предварительный расчёт не является обещанием выкупа.",
  },
  {
    ...
    answer:
      "Да. Проверка проходит открыто: можно увидеть, какие функции проверены и какие замечания попали в Passport.",
  },
  {
    ...
    answer:
      "Нет. Условия зависят от категории, состояния и конкретной вещи. Смотрите гарантийный блок в Passport и карточке устройства.",
  },
  {
    key: "club-what",
    category: "club",
    ...
    answer:
      "Это тестовый формат обновления вокруг конкретного проверенного устройства. Стоимость, сроки и обязательства рассчитываются индивидуально и показываются до участия.",
  },
  {
    key: "club-upgrade",
    category: "club",
    ...
    answer:
      "Да. До участия вы получите индивидуальный расчёт. Итоговая стоимость техники подтверждается после диагностики.",
  },
  {
    key: "club-exit",
    category: "club",
    ...
    answer:
      "Нет. Итог зависит от состояния устройства при повторной диагностике, комплектации и спроса.",
  },
  {
    key: "club-conditions",
    category: "club",
    ...
    answer:
      "Нет. Они зависят от конкретного устройства и согласованного сценария. Полный расчёт предоставляется до принятия решения.",
  },
];
