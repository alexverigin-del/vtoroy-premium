...
const items = [
  ...
  },
  {
    ...
    answer: "Это ориентир, по которому вещь может пойти дальше через круг I СВОИ после повторной проверки и подтверждения состояния.",
  },
  {
    key: "club-conditions",
    category: "club",
