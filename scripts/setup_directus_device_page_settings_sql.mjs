...
const leadFieldSpecs = [
  ...
  },
  {
    ...
    interface: "input-multiline",
    width: "full",
    note: "Текст согласия под формой. Показывается рядом с кнопкой заявки.",
    translation: "Согласие под формой",
  },
  {
    suffix: "idle_note",
    db: "text",
...
CREATE TABLE IF NOT EXISTS device_page_settings (
  ...
  warranty_title varchar DEFAULT 'Гарантия и условия обновления',
  warranty_duration_label varchar DEFAULT 'Срок гарантии',
  exit_price_label varchar DEFAULT 'Предварительная стоимость при обновлении',
  ...
  trade_value_prefix varchar DEFAULT 'Предварительная оценка',
  trade_cta_label varchar DEFAULT 'Получить предварительную оценку',
...
ALTER TABLE device_page_settings
  ...
  ADD COLUMN IF NOT EXISTS warranty_title varchar DEFAULT 'Гарантия и условия обновления',
  ADD COLUMN IF NOT EXISTS warranty_duration_label varchar DEFAULT 'Срок гарантии',
  ADD COLUMN IF NOT EXISTS exit_price_label varchar DEFAULT 'Предварительная стоимость при обновлении',
  ...
  ADD COLUMN IF NOT EXISTS trade_value_prefix varchar DEFAULT 'Предварительная оценка',
  ADD COLUMN IF NOT EXISTS trade_cta_label varchar DEFAULT 'Получить предварительную оценку',
