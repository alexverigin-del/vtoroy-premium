...
SELECT isvoi_inventory_preset('inventory_items','1 · Проверить происхождение','policy','#dc2626','{"authenticity_status":{"_in":["pending","review","blocked"]}}','["source_title","source_sku","quantity","authenticity_status","eligibility_status","block_reason"]','["source_title"]');
SELECT isvoi_inventory_preset('inventory_items','2 · Исправить идентичность','fingerprint','#dc2626','{"identity_status":{"_eq":"conflict"}}','["source_title","source_sku","quantity","identity_status","authenticity_status","block_reason"]','["source_title"]');
SELECT isvoi_inventory_preset('inventory_items','3 · Готово к передаче','publish','#059669','{"eligibility_status":{"_eq":"eligible"}}','["source_title","source_sku","quantity","retail_price","product","review_note"]','["source_title"]');
SELECT isvoi_inventory_preset('inventory_items','4 · Передано в карточки сайта','check_circle','#2563eb','{"_and":[{"eligibility_status":{"_eq":"eligible"}},{"product":{"_nnull":true}}]}','["source_title","source_sku","quantity","retail_price","product","review_note"]','["source_title"]');
...
SELECT isvoi_inventory_preset('product_channel_listings','1 · Avito: черновики','edit_note','#64748b','{"_and":[{"channel":{"_eq":"avito"}},{"status":{"_eq":"draft"}}]}','["external_id","product","status","category_mapping","price_override","sync_status"]','["external_id"]');
SELECT isvoi_inventory_preset('product_channel_listings','3 · Avito: активные','campaign','#2563eb','{"_and":[{"channel":{"_eq":"avito"}},{"status":{"_eq":"active"}}]}','["external_id","product","status","category_mapping","price_override","last_exported_at","sync_status"]','["external_id"]');
