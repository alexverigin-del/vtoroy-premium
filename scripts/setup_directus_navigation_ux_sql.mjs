...
SELECT pg_temp.isvoi_navigation_item(
  '64cf08a2-06fe-4a34-a6f2-7f264562d543','Магазин в Северодвинске','/store','header',NULL,2,'page','store'
);
SELECT pg_temp.isvoi_navigation_item(
...
SELECT pg_temp.isvoi_navigation_item(
  '5a2a6b8d-73e6-4b15-9dfc-1b91c7f16001','Магазин в Северодвинске','/store','footer',
  '0c0ea292-7eb0-4983-af42-cd78f24d0a4b',1,'page','store'
);
SELECT pg_temp.isvoi_navigation_item(
