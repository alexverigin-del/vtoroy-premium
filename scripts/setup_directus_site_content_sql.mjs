...
SELECT isvoi_upsert_directus_field('page_sections', 'content', 'input-code', NULL, '{"language":"json","lineWrapping":true}'::json, NULL, 'full', 91, 'JSON-настройки для сложных блоков. Для обычного текста и главной картинки используйте поля выше. Не добавляйте image_src/imageSrc, /assets/... или прямые asset URL в JSON.', true, false, false, 'json', 'group_advanced', 'JSON-настройки блока');
