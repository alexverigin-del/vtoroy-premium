...
const fields = {
  ...
  directusFilesCreate: "title,description,folder,file,tags",
  ...
  catalogImportBatchesTechnicalWrite: "status,last_run_mode,last_run_status,last_run_log,last_run_at",
  ...
  navigationItems: "id,label,label_short,aria_label,link_type,page,section_anchor,custom_url,url,location,parent,children,sort,is_active,open_in_new,item_role,icon",
...
const updates = [
  ...
  ["ISVOI Importer", "devices", "create", fields.devices],
  ["ISVOI Importer", "devices", "update", fields.devices],
  ...
  ["ISVOI Catalog Import", "catalog_import_batches", "update", fields.catalogImportBatchesTechnicalWrite],
  ["ISVOI Catalog Import", "devices", "read", fields.devices],
  ["ISVOI Catalog Import", "devices", "create", fields.devices],
  ["ISVOI Catalog Import", "devices", "update", fields.devices],
...
lines.push(
  ...
  "  AND pe.collection IN ('devices', 'device_images', 'device_passports', 'trade_options', 'directus_folders', 'faq_items', 'lead_comments', 'leads', 'navigation_items', 'page_sections', 'site_pages', 'site_settings', 'catalog_import_batches')",
  "  AND pe.fields <> '*';",
  "",
  "COMMIT;",
);
